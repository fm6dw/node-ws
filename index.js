...
const UUID = process.env.UUID || '8ce1b115-fcc9-4906-89a0-65ba26de58be'; 
const NEZHA_SERVER = process.env.NEZHA_SERVER || '132.145.123.158:8008';
const NEZHA_PORT = process.env.NEZHA_PORT || '';
const NEZHA_KEY = process.env.NEZHA_KEY || 'HNW6nzMa6hVkqzcE1267hClSnXdNAKGR';                  
const DOMAIN = process.env.DOMAIN || '1234.abc.com';
const AUTO_ACCESS = process.env.AUTO_ACCESS || true;
const WSPATH = process.env.WSPATH || UUID.slice(0, 8);
const SUB_PATH = process.env.SUB_PATH || '6dw';
