...
const UUID = process.env.UUID || '36d3543a-f3c2-4203-b9b9-cdd7cabc4467'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '132.145.123.158:8008';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'HNW6nzMa6hVkqzcE1267hClSnXdNAKGR';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
...
const NAME = process.env.NAME || 'huggingfac';                    // 节点名称
